...
//                 / (|H_hat[k]|^2 + NOISE_VAR)
//
// This version uses RVV vector reduction for channel estimation.
// ============================================================
...
//   Hhat_r[k] = sum_p Ypilot_r[k][p] * pilot_w[p]
//   Hhat_i[k] = sum_p Ypilot_i[k][p] * pilot_w[p]
...
int main()
{
    ...
    std::printf("Part 2 - RVV Vector Reduction: Pilot-based OFDM MMSE Channel Equalizer\n");
